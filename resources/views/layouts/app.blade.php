...
<head>
    ...
    <title>{{ config('app.name', 'Dantown Test') }}</title>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item me-2">
                            <span class="nav-link">
                                Wallet Balance: {{ Auth::user()->wallet->balance }}
                                @if (Auth::user()->role === 'checker')
                                <i class="bi bi-bank" title="Checker's Balance"></i>
                                @endif
                            </span>
                        </li>
                        @endauth
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('transactions.pending') }}">
